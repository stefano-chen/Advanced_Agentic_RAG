...
def get_topics(folder_path: str) -> List[str]:
    """
...
def save_to_png(agent: CompiledStateGraph, file_name: str) -> None:
    """
...
def stream_response(agent: CompiledStateGraph[AgentState], user_query: str, chat_history: str,  verbosity: int = 0) -> str:
    """
